# -*- coding: utf-8 -*-
"""LSTM_classification_model.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Gc0h7dLgYZPnqsCd4_B1_gHLM14K7Cjw
"""
...
class Model(nn.Module):
    def __init__(self, vocab_size, embed_size, hidden_size):
        ...
        self.scoring = nn.Linear(hidden_size,5)
        ...
        self.secondary_layers.append(nn.Linear(64,5))
    ...
    def forward(self, inputs, text_lengths):
        ...
        #primary_pred = self.rnn_scoring(torch.cat([out_text,secondary_out],dim=1))
...
for epoch in range(20):
    ...
    for batch_idx,(inputs, targets, input_lens) in enumerate(train_loader):
        ...
        batch_acc = torch.sum(indices==targets).item()
        train_acc += batch_acc
    ...
    with torch.no_grad():
        for batch_idx,(inputs, targets, input_lens) in enumerate(val_loader):
            ...
            values,indices = torch.max(out,dim=1)
            val_acc += torch.sum(indices==targets).item()
